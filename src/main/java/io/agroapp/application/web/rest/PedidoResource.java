...
/**
 * REST controller for managing {@link io.agroapp.application.domain.Pedido}.
 */
@RestController
@RequestMapping("/api")
public class PedidoResource {
     ...
     */
    @GetMapping("/pedidos")
    public ResponseEntity<List<Pedido>> getAllPedidos(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
