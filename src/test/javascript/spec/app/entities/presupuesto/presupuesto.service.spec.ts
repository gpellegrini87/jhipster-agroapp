...
describe('Service Tests', () => {
    describe('Presupuesto Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Presupuesto(0, 'AAAAAAA');
        });
        ...
        describe('Service methods', () => {
            ...
            it('should create a Presupuesto', async () => {
            ...
            it('should update a Presupuesto', async () => {
                const returnedFromService = Object.assign(
                    {
                        nombre: 'BBBBBB'
                    },
            ...
            it('should return a list of Presupuesto', async () => {
                const returnedFromService = Object.assign(
                    {
                        nombre: 'BBBBBB'
                    },
            ...
            it('should delete a Presupuesto', async () => {
